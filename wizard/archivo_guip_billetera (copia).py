...
class PayslipBatchesBanco(models.Model):
   ...
   #ULTIMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    ...
    def get_nomi_data_guip(self):
        ...
        file_name = _('PayrollPointUpload_Guip_' + str(nombre_archivo) + '.csv')
        fp = BytesIO()
        ...
        worksheet = workbook.add_worksheet('PayrollPointUpload_Guip_' + str(nombre_archivo) + '.csv')
        ...
        for slip in self.slip_ids:
            ...
            worksheet.write(row, 1, self.date_end, cell_text_format)
